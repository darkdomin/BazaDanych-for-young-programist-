...
{
    public partial class Zlozone : Form
    {
        //ZMIENNE
        int id;
        ...
        //Konstruktor
        public Zlozone(int nr, string x, string y, string z)
        {
            InitializeComponent();
            tytul = x;
            opis = y;
        ...
        private void btnModify_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    "update baza.zlozone set Nazwa='" + txtTitle.Text + "',Opis='" + txtDescription.Text + "',kod='" + txtKod.Text + "' where idProgramy=" + id + ";";
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    zapytanie.CommandText =
                    "insert into baza.zlozone set Nazwa='" + txtTitle.Text + "',Opis='" + txtDescription.Text + "',kod='" + txtKod.Text + "';";
                    zapytanie.ExecuteNonQuery();
                    transakcja.Commit();
                    MessageBox.Show("Dodane do bazy");
                }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    zapytanie.CommandText =
                    "Delete from baza.zlozone  where idProgramy=" + id + ";";
                    zapytanie.ExecuteNonQuery();
                    transakcja.Commit();
        ...
        private void Zlozone_Load(object sender, EventArgs e)
        {
            txtKod.Text = kod;
            txtTitle.Text = tytul;
