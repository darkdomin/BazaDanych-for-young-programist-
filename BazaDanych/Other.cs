...
namespace BazaDanych
{
    public partial class Other : Form
    {
        ...
        //Konstruktor
        public Other(int nr, string x, string y, string z)
        {
            InitializeComponent();
            tytul = x;
            opis = y;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    "insert into baza.other set Nazwa='" + txtTitle.Text + "',Opis='" + txtDescription.Text + "',kod='" + txtKod.Text + "';";
        ...
        private void btnModify_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    zapytanie.CommandText =
                    "update baza.other set Nazwa='" + txtTitle.Text + "',Opis='" + txtDescription.Text + "',kod='" + txtKod.Text + "' where idOther=" + id + ";";
                    zapytanie.ExecuteNonQuery();
                    transakcja.Commit();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    zapytanie.CommandText =
                    "Delete from baza.other  where idOther=" + id + ";";
                    zapytanie.ExecuteNonQuery();
                    transakcja.Commit();
